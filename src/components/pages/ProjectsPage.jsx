...
const ProjectsPage = () => {
  ...
  return (
    ...
    <div className='"max-w-[1000px] w-full mx-auto px-4 py-1'>
      ...
      <div className="wrapper ">
        ...
        <div className='bg-[#00abf0] flex flex-col lg:flex-row lg:gap-0 gap-2 rounded-lg py-1 justify-center lg:justify-around items-center lg:w-[500px] mx-auto'>
          ...
          <button id="3"  onClick={()=> handleClick(3)}
           className={`${checkActive(3, "bg-[#081b29] px-3 rounded-md text-[#ededed] transition")}`}
          >Others...</button>
        </div>
  ...
  <div className='left max-w-[320px]'>
    <img src="https://via.placeholder.com/200x200" alt="" className='w-[450px] h-[230px] rounded-xl object-cover'/>
  </div>
